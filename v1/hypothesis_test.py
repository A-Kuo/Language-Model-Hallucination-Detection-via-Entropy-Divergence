...
class CalibrationBaseline:
    ...
    These defaults are reasonable starting points for small causal LMs on factual text.
    """
    # Entropy baseline (across all layers & heads)
    entropy_mean: float = 2.8       # bits — typical for small causal LMs on factual text
...
# Default baselines (estimated from small causal LMs)
